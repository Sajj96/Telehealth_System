...
<html lang="en" dir="ltr">
       ...
       <div class="w3-main" id="main">
         ...
         <div class="w3-sidebar w3-bar-block w3-collapse w3-animate-top w3-bordered " id="mySidebar">
          ...
          <div class="">
              ...
              <?php else: ?>
              <a href="<?php echo site_url('doctor/')?>" class="w3-bar-item w3-round w3-text-white w3-orange w3-hover-cyan w3-button"><i class="fa fa-user-md fa-fw w3-text-white"></i>Search Doctor</a>
        ...
        <div class="" id="mainpage">
          <div class="w3-container">
            <h3 class="w3-large w3-text-green"><i class="fa fa-user-md fa-fw w3-text-green"></i>Search preffered Doctor:</h3>
              <hr>
            </div>
              <i class="fa fa-search fa-fw fa-1x w3-text-green w3-left w3-margin-top"></i><input type="text" name="search_text" id="search_text" placeholder="Search Doctor Details" class="w3-input" />
            <br>
            <div id="result" class="w3-responsive"></div>
  ...
  $(document).ready(function(){
  	...
  	{
  		$.ajax({
  			url:"<?php echo site_url('Doctor/fetch'); ?>",
  			method:"POST",
  			data:{query:query},
